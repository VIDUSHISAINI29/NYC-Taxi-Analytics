...
def time_analysis():
    ...
    # Trips by Hour
    trips_by_hour = connection.execute("""
        SELECT
    ...
    # Trips by Weekday
    trips_by_weekday = connection.execute("""
        SELECT
    ...
    average_fare_by_hour = connection.execute("""
        SELECT
            EXTRACT(HOUR FROM tpep_pickup_datetime) AS hour,
    ...
    # Average Tip by Hour
    average_tip_by_hour = connection.execute("""
        SELECT
            EXTRACT(HOUR FROM tpep_pickup_datetime) AS hour,
    ...
    trips_by_month = connection.execute("""
        SELECT
